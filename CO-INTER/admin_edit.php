...
<body>
    ...
    <div id="content">
        <div style="padding-left:2em;padding-right:2em;" class="row">
            ...
            <form action="fungsi_edit_admin.php" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-6">
                        <label>Nama</label>
                        <input hidden class="form-control" type="text" value="<?php echo $list["id"]?>" name="id"/>
                        <input class="form-control" type="text" value="<?php echo $list["nama"]?>" name="nama" placeholder="masukan nama"/>
                    </div>
                    <div class="col-sm-6">
                        <label>Email</label>
                        <input value="<?php echo $list["email"]?>" class="form-control" type="email" name="email" placeholder="masukan email"/>
                    </div>
                    <div class="col-sm-6">
                        <label>Nik</label>
                        <input value="<?php echo $list["nik"]?>" class="form-control" type="nik" name="nik" placeholder="masukan nik"/>
                    </div>
                    <div class="col-sm-6">
                        <label>Role</label>
                        <?php if($list["role"] == 1) : ?>
                    ...
                    <div class="col-sm-12 custom-file">
                        <input value="<?php echo $list["image"]?>" class="custom-file-input form-control" type="file" id="gambar" name="gambar">
                    </div>

                    <div class="col-sm-12">
                        <label>Password</label>
                        <input value="<?php echo $list["password"]?>" class="form-control" type="password" name="password" placeholder="masukan password"/>
                    </div>
                    <div class="col-sm-12">
